...
# print("Posición 2 de mi lista,", mascotas[1])
# # Escribe el código para agregar un elemento a la lista, imprimir por consola la lista
# mascotas.append('pez')
...
print("Número de elementos en nuestra tupla,", len(plantas))
# Escribe el código para acceder al valor de la posición 2, imprimir por consola
print("Valor de la posición 2,", plantas[1])
...
#Las tuplas son inmutables, no podemos modificar, añadir o eliminar ningún elemento de las mismas.
"""
 --- SETS ---
